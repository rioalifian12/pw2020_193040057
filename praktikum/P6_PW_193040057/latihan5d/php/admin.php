    ...
    <table class="table">
      ...
      <?php foreach ($tubes_193040057 as $tubes) : ?>
        <tr>
          <td><?= $i ?></td>
          <td>
            <button type="button" class="kembali btn btn-primary"><a href="ubah.php?id=<?= $tubes['id']; ?>" class="text-light">Ubah</a></button>
            <button type="button" class="kembali btn btn-danger"><a href="hapus.php?id=<?= $tubes['id']; ?>" onclick="return confirm('Hapus Data??')" class="text-light">Hapus</a></button>
          </td>
          <td>
            <div class="gambar">
